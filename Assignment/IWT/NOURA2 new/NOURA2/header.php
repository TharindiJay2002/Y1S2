...
<div class="icons"><a href="Nadee_cart.php">  <dij class="cart"> <i class="fa-solid fa-cart-shopping"></i> </dij> </a> <a href="Profile.php"><i class="fa-solid fa-user-large"></i></a> </div>
